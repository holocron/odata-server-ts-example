...
export declare class Parser {
    odataUri(source: string, options?: any): Token;
    resourcePath(source: string, options?: any): Token;
    query(source: string, options?: any): Token;
    filter(source: string, options?: any): Token;
    keys(source: string, options?: any): Token;
    literal(source: string, options?: any): Token;
}
